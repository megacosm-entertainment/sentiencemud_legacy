...
//    char buf[MAX_STRING_LENGTH];
    ...
    */
    ...
    if (!IS_SITH(ch) || !IS_SET(ch->parts, PART_LONG_TONGUE))
    	act( "$n scans $s environment.", ch, NULL, NULL, NULL, NULL, NULL, NULL, TO_ROOM, NULL, NULL );
    else
    ...
    if ( fAuto )
    {
        ...
        if (!IS_SITH(ch) || !IS_SET(ch->parts, PART_LONG_TONGUE))
            act("$n poises $mself stealthily and scans the area.", ch, victim, NULL, NULL, NULL, NULL, NULL, TO_ROOM, NULL, NULL );
        else
