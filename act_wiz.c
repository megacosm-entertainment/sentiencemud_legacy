...
void do_force(CHAR_DATA *ch, char *argument)
{
	...
	interpret(victim, argument);
	act("Forced $T to \"$t\".", ch, NULL, NULL, NULL, NULL, argument, name, TO_CHAR, NULL, NULL);
    }
...
void do_addcommand(CHAR_DATA *ch, char *argument)
{
    ...
    if (command->rank <= get_staff_rank(vch)) {
        act("$N can already use that command due to $S rank.", ch, vch, NULL, NULL, NULL, NULL, NULL, TO_CHAR, NULL, NULL);
	return;
    }
