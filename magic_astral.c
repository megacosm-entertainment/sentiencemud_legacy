...
SPELL_FUNC(spell_maze)
{
	...
	if (stone) {
		act("You draw upon the power of $p.",ch, NULL, NULL,stone,NULL, NULL, NULL,TO_CHAR, NULL, NULL);
		act("$p flares brightly and vanishes!",ch, NULL, NULL,stone,NULL, NULL, NULL,TO_CHAR, NULL, NULL);
		extract_obj(stone);
	} else {
