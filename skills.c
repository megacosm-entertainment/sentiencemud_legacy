...
void do_practice( CHAR_DATA *ch, char *argument )
{
	...
	if (!argument[0])
	{
		if (list_size(abilities) > 0)
		{
			...
			if (total > 0)
			{
				...
				act("$N has nothing to teach you.", ch, mob, NULL, NULL, NULL, NULL, NULL, TO_CHAR, NULL, NULL);
	...
	if (cost)
	{
		...
		else
		{
			...
			if (haggled)
			{
				act("You haggle with $N.",ch,mob, NULL, NULL, NULL, NULL, NULL,TO_CHAR, NULL, NULL);
		...
		if (entry->rating < pe->max_rating) {
			act("You practice $T from $N.", ch, mob, NULL, NULL, NULL, NULL, name, TO_CHAR, NULL, NULL);
			act("$n practices $T from $N.", ch, mob, NULL, NULL, NULL, NULL, name, TO_ROOM, NULL, NULL);
		} else {
			entry->rating = pe->max_rating;
			act("{WYou have learned all you can from $N about $T.{x", ch, mob, NULL, NULL, NULL, NULL, name, TO_CHAR, NULL, NULL);
			act("{W$n has learned all $e can from $N about $T.{x", ch, mob, NULL, NULL, NULL, NULL, name, TO_ROOM, NULL, NULL);
		}
	}
	else
	{
...
void do_setclass(CHAR_DATA *ch, char *argument)
{
	...
	act("You switch to $t.", ch, NULL, NULL, NULL, NULL, level->clazz->display[ch->sex], NULL, TO_CHAR, NULL, NULL);
	act("$n switches to $t.", ch, NULL, NULL, NULL, NULL, level->clazz->display[ch->sex], NULL, TO_ROOM, NULL, NULL);
