...
void do_play(CHAR_DATA *ch, char *argument)
{
	...
	if (target == TARGET_CHAR)
	{
		if (mob == ch)
		{
			if(instrument == NULL)
			{
				...
				act( "{Y$n begins to sing a song softly to $mself...{x", ch, NULL, NULL, NULL, NULL, NULL, NULL, TO_ROOM, NULL, NULL);
			}
			else
			{
				// Instrument
				act( "{YYou begin to play the song on $p{Y softly to yourself...{x", ch, NULL, NULL, instrument, NULL, NULL, NULL, TO_CHAR, NULL, NULL);
		...
		else
		{
			...
			{
				// Vocal
				act("{YYou begin to sing the song, sweetly exerting its influence on $N...{X", ch, mob, NULL, NULL, NULL, NULL, NULL, TO_CHAR, NULL, NULL);
				act("{Y$n begins to sing a song, exerting its influence on $N...{X", ch, mob, NULL, NULL, NULL, NULL, NULL, TO_NOTVICT, NULL, NULL);
				act("{Y$n begins to sing a song, exerting its influence on you...{X", ch, mob, NULL, NULL, NULL, NULL, NULL, TO_VICT, NULL, NULL);
			}
			else
			{
				// Instrument
				act("{YYou begin to play the song on $p{Y, sweetly exerting its influence on $N...{X", ch, mob, NULL, instrument, NULL, NULL, NULL, TO_CHAR, NULL, NULL);
				act("{Y$n begins to play a song on $p{Y, exerting its influence on $N...{X", ch, mob, NULL, instrument, NULL, NULL, NULL, TO_NOTVICT, NULL, NULL);
				act("{Y$n begins to play a song on $p{Y, exerting its influence on you...{X", ch, mob, NULL, instrument, NULL, NULL, NULL, TO_VICT, NULL, NULL);
			}
	...
	else
	{
		if (instrument == NULL)
		{
			act( "{YYou begin to sing a song...{x", ch, NULL, NULL, NULL, NULL, NULL, NULL, TO_CHAR, NULL, NULL);
			act( "{Y$n begins to sing a song...{x", ch, NULL, NULL, NULL, NULL, NULL, NULL, TO_ROOM, NULL, NULL);
		}
		else
		{
...
void music_end( CHAR_DATA *ch )
{
	...
	if (chance < number_range(0, 9999))
	{
		...
		{
			act( "{YYou mispronounce a word while singing your song.{x", ch, NULL, NULL, NULL, NULL, NULL, NULL, TO_CHAR, NULL, NULL);
			act( "{Y$n mispronounces a word while singing $s song.{x", ch, NULL, NULL, NULL, NULL, NULL, NULL, TO_ROOM, NULL, NULL);
		}
		else
		{
			act( "{YYou play an incorrect note on $p{Y.{x", ch, NULL, NULL, ch->song_instrument, NULL, NULL, NULL, TO_CHAR, NULL, NULL);
			act( "{Y$n plays an incorrect note on $p{Y.{x", ch, NULL, NULL, ch->song_instrument, NULL, NULL, NULL, TO_ROOM, NULL, NULL);
		}
	...
	else
	{
		if (ch->song_instrument == NULL)
		{
			act( "{YYou finish singing your song.{x", ch, NULL, NULL, NULL, NULL, NULL, NULL, TO_CHAR, NULL, NULL);
			act( "{Y$n finishes $s song.{x", ch, NULL, NULL, NULL, NULL, NULL, NULL, TO_ROOM, NULL, NULL);
		}
		else
		{
			act( "{YYou finish playing your song on $p{Y.{x", ch, NULL, NULL, ch->song_instrument, NULL, NULL, NULL, TO_CHAR, NULL, NULL);
			act( "{Y$n finishes $s song on $p{Y.{x", ch, NULL, NULL, ch->song_instrument, NULL, NULL, NULL, TO_ROOM, NULL, NULL);
		}
	}
